...
class GenerateTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.VERIFY_FILES.add(CERT_FILESIG)
        self.DOWNLOAD_FILES.add(CERT_FILENAME)
    ...
    def test_cert_gen(self):
        ...
        for course_id in settings.CERT_DATA.keys():
            ...
            if settings.CERT_DATA[course_id].get('VERIFY', True) and verify_uuid:
                ...
                assert_true(set(verify_files) == self.VERIFY_FILES)
                ...
                assert_true(set(download_files) == self.DOWNLOAD_FILES)
            try:
    ...
    def test_creates_default_dir(self, gen_dir):
    ...
    @raises(ValueError)
    def test_uncovered_unicode_cert_name(self):
        """
    ...
    def test_cert_upload(self):  # pragma: no cover
    ...
    def test_render_flair_function_false(self):
        """
    ...
    def test_render_flair_function_true(self):
        """
